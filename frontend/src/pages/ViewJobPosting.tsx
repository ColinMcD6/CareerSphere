...
const ViewJobPosting = () => {
  ...
  return (
    <div className="container mt-4"> {/* Add a container with margin-top */}
      <div className="card mb-4 shadow"> {/* Add shadow for better visual appeal */}
      <h2 className="card-header bg-primary text-white ">{data.title}</h2>
        <div className="card-body">
          <h5 className="card-subtitle mb-3 text-muted">Position Title: {data.positionTitle}</h5>
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              ...
              <p className="card-text">
                <strong>Date Posted:</strong> {new Date(data.datePosted).toLocaleDateString()}
              </p>
              <p className="card-text">
